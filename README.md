...
Приложение развернуто по адресу: http://ynm-project.online и можно проверить его функциональность.

Например, посмотреть все произведения можно по адресу: http://ynm-project.online/api/v1/titles/
